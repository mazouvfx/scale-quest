...
export const SCALE_PATTERNS: Record<string, Omit<ScaleDef,'key'|'family'>> = {
  ...
  diminished: { label: 'Diminuée (H-W)', formula: 'H W H W H W H W', intervals: [0,1,3,4,6,7,9,10], tips: 'Seulement 3 collections distinctes. Pense b9, #9, b5 sur un accord dom7.' },
  dorian: { label: 'Dorien', formula: '1 2 b3 4 5 6 b7', intervals: [0,2,3,5,7,9,10], tips: 'La 6e majeure sur fond mineur. Couleur jazz douce, base du funk.
Think D dorian = D E F G A B C' },
  mixolydian: { label: 'Mixolydien', formula: '1 2 3 4 5 6 b7', intervals: [0,2,4,5,7,9,10], tips: 'Majeur avec une b7. Idéal sur les dominantes. Oscar Peterson aimait les runs mixo.' },
  melodicMinor: { label: 'Mineure mélodique', formula: '1 2 b3 4 5 6 7', intervals: [0,2,3,5,7,9,11], tips: 'Super-Locrien (7e mode) = altérée. Tension maximale sur V7alt.' },
  bebop: { label: 'Bebop dominante', formula: '1 2 3 4 5 6 b7 7', intervals: [0,2,4,5,7,9,10,11], tips: 'Gamme à 8 notes. Les accords tombent toujours sur les temps forts.' },
  funkMinor: { label: 'Funk penta mineure', formula: '1 b3 4 5 b7', intervals: [0,3,5,7,10], tips: 'Même que mineure penta mais pense en syncopes. Accent sur le 2 et le 4.' }
}
